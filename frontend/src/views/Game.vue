                    ...
                    <v-list-item v-for="user in users" :key="user.id">
                        <v-card class="my-4" height="150px" width="180px">
                            ...
                            <v-card-subtitle class="my-auto">
                                <b>Баланс: {{user.bank}}$</b>
                            </v-card-subtitle>
                            <v-card-text v-if="user.turn" style="color: indianred">
                                <b> Ходит </b>
                            </v-card-text>
                        </v-card>
        ...
        <v-col cols="2" style="margin-right: 150px;" class="pa-0">
            <div style=" height: 750px;">
                <v-row class="my-12">
                    ...
                    <v-col cols="12">
                        <v-btn depressed color="primary" width="100%" height="60px">
                            <h3>Сделать ход </h3>
                        </v-btn>
                    </v-col>
                    <v-col cols="12">
...
<script>
    export default {
        ...
        data: () => ({
            properties: [],
            users: [{"name": "Евгений Гутин", "bank": 1200, "position": 2, "turn": true},
                    {"name": "Второй игрок", "bank": 1300, "position": 5, "turn": false}],
            incomeData: [
                ...
                {"owner":"Валера Мазафакер", "color": "purple", "id": 12,"position": 33, "name": "Сбербанк", "price": 1200},
        ...
        methods: {
            getProperties() {
                this.properties.push({"id":0, "position": 0, "name":"START", "price":"Получить 200", "color": "black"});
                for (let i=1; i<36; i++){
